...
\begin{itemize}
   \item \textit{Factoid questions}, the most common type, is typically signaled by question words (what, when, which, who, how) and yield a concise factual answer.
...
\begin{figure}
    ...
    \caption{Reader-Retriever-System Architecture for \gls{qa} by Zhu et al. \cite{zhu_retrieving_2021}.}
